...
class Dino extends Phaser.GameObjects.Sprite {
    constructor(scene, x, y, texture, frame) {
        ...
        this.sfxDown = scene.sound.add('down', {volume: 0.1});
        this.sfxUp = scene.sound.add('up', {volume: 0.1});
        this.sfxLeft = scene.sound.add('left', {volume: 0.1});
        this.sfxRight = scene.sound.add('right', {volume: 0.1});
        this.sfxHover = scene.sound.add('hover', {volume: 0.1});
        this.sfxBrake = scene.sound.add('brake', {volume: 0.1});
